...
1. [Batch Runner Script](#1.BatchTriggerValidationRunner)
2. [Summary Plotting for Merged Validation Histograms](#2.TriggerValidationSummaryPlotter)
3. [HyCal XY Trigger Efficiency Analysis and Plotting](#3.HyCalXYTriggerEfficiencyAnalysis)
---
